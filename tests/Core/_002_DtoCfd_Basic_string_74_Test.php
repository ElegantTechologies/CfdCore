...
class Naked extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
}

class Simple_0y_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
    public $caresGiven; // Must be set, but not type enforced.
}

class Simple_0z_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
    public ?int $caresGiven = null; // Just proving this compiles
}
class Simple_0_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
    public int $caresGiven = 0; // must only create w/ an optional int
}
class Simple_0b_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
    public ?int $caresGiven = 0; // must only create w/ an optional int, or null
}

class Simple_0c_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
    public int $caresGiven; // must create with a mandatory int
}
class Simple_0d_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
    public ?int $caresGiven; // must create with a mandatory int, or null
}

class Simple_0e_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
     #public string $caresGiven2 = 0; // wouldn't event compile cuz type mismatch
}
class Simple_1_Cfd extends  \ElegantTechnologies\Cfd\Core\CfdBase
{
 ...
 */
class NamedThingsCfd extends \ElegantTechnologies\Cfd\Core\CfdBase
{
