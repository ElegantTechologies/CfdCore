...
final class Cfesz_Test extends TestCase
{
    ...
    function testBasics2()
    {
        ...
        try {
            ...
            $this->assertTrue(false, "ElegantTechnologies\Cfd\Core\CfdError: 'zero' is not a valid enumeration for ElegantTechnologies\Cfd\Lib\Cfesz::valuePossibilities([one, two, three])");
